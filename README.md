...
This project implements a modern microservices architecture using Spring Boot for the backend and Angular 18 for the frontend. It includes an API Gateway, authentication with Keycloak, messaging via Kafka, and monitoring with the Grafana Stack, all orchestrated in Kubernetes for scalable deployments.
